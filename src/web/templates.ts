...
.gp-agents-pip-filled {
  background: #c084fc;
  box-shadow: 0 0 4px rgba(192,132,252,.4);
}
.gp-agents-pip-overflow {
  font-size: .65rem;
  color: #c084fc;
  margin-left: 2px;
}

.gp-agents-refine-btn {
  background: transparent;
...
.gp-agents-refine-btn:hover {
  border-color: #c084fc;
  background: rgba(168,85,247,.1);
}
.gp-agents-refine-btn:disabled {
  opacity: .6;
  cursor: wait;
}

.gp-agents-card-refining {
...
.gp-refine-trail:hover {
  border-color: rgba(168,85,247,.4);
  background: rgba(168,85,247,.12);
}
.gp-refine-trail-title {
  font-size: .8rem;
  font-weight: 600;
  color: var(--gp-text);
  margin-bottom: .15rem;
...
.gp-refine-notes-input:focus {
  border-color: rgba(168,85,247,.4);
}
.gp-refine-notes-input::placeholder {
  color: #64748b;
}
.gp-refine-hint {
  font-size: .7rem;
...
.gp-refine-result-header {
  display: flex;
  align-items: center;
  gap: .5rem;
  margin-bottom: .4rem;
}
.gp-refine-result-badge {
  font-size: .65rem;
  font-weight: 700;
  padding: .15rem .45rem;
  border-radius: 2rem;
...
.gp-refine-result-title {
  font-size: .8rem;
  font-weight: 600;
  color: var(--gp-text);
  flex: 1;
}
.gp-refine-result-close {
  background: none;
  border: none;
  color: #94a3b8;
  cursor: pointer;
...
.gp-refine-result-close:hover { color: var(--gp-text); }
