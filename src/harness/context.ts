...
function formatToolGuidance(soulId: number): string {
  ...
  const base = [
    "## Tools",
    "",
    "You have filesystem tools (ls, grep, read, write, bash) for the user's workspace files,",
    "web tools for browsing, and extension tools (MCP).",
    "",
    "All agent state — memory, pack bonds, quests, storylines, souls — lives in a SQLite database,",
    "NOT in the filesystem. Never ls/grep/read the database file. Always delegate:",
    "- Warden: memory, pack bonds, quests, storylines, relationship data",
    "- Chamberlain: config, secrets, budget, scheduling (never OS cron/crontab)",
    "- Mentor: soul development, traits, identity",
    "- Trainer: skill development, creating/improving procedures",
    "- Historian: trail analysis, chronicle work",
    "",
    "Default to delegation for any question about what the system knows or remembers.",
    "Use filesystem tools only for the user's actual workspace content.",
