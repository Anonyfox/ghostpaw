...
function findUniqueMatch(content: string, search: string): MatchResult {
...
export function findAndReplace(
  ...
  switch (match.kind) {
    ...
    case "none":
      throw new Error(
        "Search string not found in file content. Verify the search string matches exactly, including whitespace.",
      );
  }
}
