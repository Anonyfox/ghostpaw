...
Single-process AI agent runtime. One compiled artifact, one SQLite database, one process. Evolutionary identity, provider-independent persistence. Ghostpaw — the agent that grows.
...
|--------|------|--------|----------------|
| Chat | `docs/features/CHAT.md` | **Implemented** | Omnichannel turn execution, sessions, tools, compaction, haunt-capable substrate |
| Souls | `docs/features/SOULS.md` | **Implemented** | Evolutionary identity, traits, refinement, level-up |
| Skills | `docs/features/SKILLS.md` | **Implemented** | Procedural knowledge as markdown, craft/train/scout pipeline |
| Trail | `docs/features/TRAIL.md` | **Implemented** | Longitudinal signals, chronicle, calibration, compounding intelligence |
...
| Quests | `docs/features/QUESTS.md` | **Implemented** | Unified task/event/calendar system, temporal awareness, Quest Board |
| Pack | `docs/features/PACK.md` | **Implemented** | Social bonds, Theory of Mind, relational identity |
| Pawprints | `docs/ideas/PAWPRINT.md` | **Spec only** | Situated experiential knowledge, discovery by presence |
