...
const WRITE_IMPORT_ALLOWLIST = new Set([
  ...
  "src/channels/cli/quests_turn_in.ts",
  "src/channels/cli/quests_storyline_add.ts",
  "src/channels/cli/quests_storyline_done.ts",
  "src/channels/cli/quests_storyline_update.ts",
  ...
  "src/harness/quest/types.ts",
  "src/harness/quest/consolidate_embark.ts",
  "src/harness/quest/plan_subgoals.ts",
  "src/harness/quest/run_embark.ts",
  "src/harness/quest/turn_in.ts",
  "src/harness/quest/run_prowl.ts",
  "src/harness/quest/run_tend.ts",
  "src/harness/quest/validate_step.ts",
