...
function formatToolGuidance(soulId: number): string {
  if (soulId === MANDATORY_SOUL_IDS.warden) {
    return [
      ...
      "",
      "Pack patrol: use pack_sense with patrol=true during maintenance to check for drifting",
      "bonds and upcoming landmarks. Act on findings: note observations, update bonds, or",
      "surface important items to the user.",
      "",
