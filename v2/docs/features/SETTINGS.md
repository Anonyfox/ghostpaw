...
**Custom schedules** — anything that runs as a shell command. Health checks, backups, workspace monitoring. The ghost creates its own recurring tasks — [self-directed temporal autonomy](https://zylos.ai/research/2026-02-16-autonomous-task-scheduling-ai-agents). [ProAgentBench](https://arxiv.org/abs/2602.04482) (500+ hours, 28,000+ events) found long-term memory significantly enhances proactive intervention timing — the ghost improves at knowing *what* to schedule the longer it runs.
